    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required("update_interval", default=DEFAULT_INTERVAL): vol.All(vol.Coerce(int), vol.Range(min=10)),
            }),
        )
    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required("update_interval", default=self.config_entry.data.get("update_interval", DEFAULT_INTERVAL)): vol.All(vol.Coerce(int), vol.Range(min=10)),
            }),
        )